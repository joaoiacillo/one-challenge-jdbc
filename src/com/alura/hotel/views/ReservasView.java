...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtDataE.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/com/alura/hotel/images/icon-reservas.png")));
		...
		lblValorSimbolo.setBounds(338, 332, 17, 25);
		...
		txtDataS.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/com/alura/hotel/images/icon-reservas.png")));
