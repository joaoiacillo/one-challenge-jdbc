...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHospede.class.getResource("/com/alura/hotel/images/lOGO-50PX.png")));
		...
		txtDataN.getCalendarButton().setIcon(new ImageIcon(RegistroHospede.class.getResource("/com/alura/hotel/images/icon-reservas.png")));
		...
		imageFundo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/com/alura/hotel/images/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/com/alura/hotel/images/Ha-100px.png")));
	}
