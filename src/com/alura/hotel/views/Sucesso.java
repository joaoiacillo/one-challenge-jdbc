...
public class Sucesso extends JDialog {
	 ...
	 */
	public Sucesso() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Sucesso.class.getResource("/com/alura/hotel/images/aH-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Sucesso.class.getResource("/com/alura/hotel/images/Ha-100px.png")));
